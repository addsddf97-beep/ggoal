...
음식 이름이나 간단한 아이디어를 입력하면 로컬 Ollama와 OpenAI API로 유튜브 숏츠용 음식 캐릭터 상황극을 생성하는 MVP입니다.

## 구조

- `apps/api`: Next.js Route Handlers 기반 백엔드 API, Ollama 텍스트 생성, OpenAI 이미지/TTS 호출, 로컬 이미지 저장
